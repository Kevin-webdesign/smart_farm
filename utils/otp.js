...
export const sendOtpEmail = async (to, otp) => {
  ...
  const mailOptions = {
    from: `SmartFarming <${process.env.EMAIL_USER}>`,
    to,
    subject: "Your SmartFarming Verification Code",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
        <div style="background-color: #4a8f29; padding: 20px; text-align: center; border-radius: 6px 6px 0 0;">
          <h1 style="color: white; margin: 0;">SmartFarming</h1>
        </div>
        
        <div style="padding: 30px;">
          <h2 style="color: #2d3748; margin-top: 0;">OTP Verification</h2>
          <p style="color: #4a5568;">Your one-time verification code for SmartFarming is:</p>
        ...
        <div style="background-color: #f8f9fa; padding: 15px; text-align: center; 
          ...
          © ${new Date().getFullYear()} SmartFarming. All rights reserved.
        </div>
      </div>
    `,
  };
